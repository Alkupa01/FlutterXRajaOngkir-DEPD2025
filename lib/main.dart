      ...
      child: MaterialApp(
        ...
        theme: ThemeData(
          ...
          inputDecorationTheme: InputDecorationTheme(
            labelStyle: GoogleFonts.roboto(color: Style.grey500),
            floatingLabelStyle: GoogleFonts.roboto(color: Style.blue800),
            hintStyle: GoogleFonts.roboto(color: Style.grey500),
